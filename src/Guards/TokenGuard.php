...
namespace Samsin33\Passport\Guards;
...
use Samsin33\Passport\PassportUserProvider;
use Samsin33\Passport\TokenRepository;
use Samsin33\Passport\TransientToken;
...
class TokenGuard
{
     ...
     *
     * @var \Samsin33\Passport\PassportUserProvider
     */
    protected $provider;
     ...
     * @param  \Samsin33\Passport\PassportUserProvider  $provider
     * @param  \Samsin33\Passport\TokenRepository  $tokens
