...
namespace Samsin33\Passport\Bridge;

use Illuminate\Contracts\Events\Dispatcher;
use Samsin33\Passport\Events\RefreshTokenCreated;
use Samsin33\Passport\RefreshTokenRepository as PassportRefreshTokenRepository;
